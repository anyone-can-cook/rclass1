...
## 1. Create a GitHub account  
  * We will be conducting all class-related discussion on this version control system instead of using CCLE. We will also use GitHub to collaborate on projects, send announcement, and ask questions. 
  * Follow these instructions to set up an account. 
  
     * Go to https://github.com/ and sign up for GitHub. Make sure to include your first and last name in your username so that we can easily identify your work/comments.
     \
     ...
     * Email your username to briannawright135@gmail.com. Please write "Git Username-[your name]" in the subject line. For example, I would write "Git Username-Brianna Wright". 
...
## 3. Install RStudio  
  ...
  * Select "RStudio-1.4.1717.exe - Windows 10" for Windows users  
  * Select "RStudio-1.4.1717.dmg - macOS 10.14+" for Mac users  
...
## 7. Install tinytex  
  ...
  * Instructions for installing tinytex  
    ...
    1. Open up RStudio  
    2. In the "console" paste the following and hit return(enter): __install.packages('tinytex')__  (When I re-installed RStudio I had to re-write the code so that it included straight quotes instead of the ones I copied and pasted from this document.)
...
*Disclaimer: We are Mac users and will do our best in assisting with any Windows issues*
