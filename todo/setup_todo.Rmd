...
## 1. Create a GitHub account  
  ...
  * Follow these instructions to set up an account. 
     ...
     * Plug in your name and Github username in the [shared spreadsheet](https://docs.google.com/spreadsheets/d/178FUVT9k8SzAxmrmXnzii2mkL_3Sj78ealIVLQ70Bro/edit#gid=0)
...
*Note: if you have already installed R and R studio you don't need to re-install, but if compatability issues arise later in the quarter, you may have to re-install*
  ...
  * Select "Download R for Windows"  
      ...
      * Click "Download R 4.2.1 for Windows" 
...
## 3. Install RStudio  
  ...
  * Select "RStudio-2022.07.1-554.exe - Windows 10/11" for Windows users  
  * Select "RStudio-2022.07.1-554.dmg - macOS 10.15+" for Mac users 
