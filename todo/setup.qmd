...
\- Follow these instructions to set up an account.
 ...
 - Plug in your name and Github username in the [shared spreadsheet](ADD LINK TO GOOGLE SHEET HERE)
...
\- Select "Download R for macOS"
 ...
 - Click either "R-4.4.1-arm64.pkg" or "R-4.4.1-x86_64.pkg" depending on the version of your Mac.
...
\- Select "RSTUDIO-2024.04.2-764.EXE" for Windows users

\- Select "RSTUDIO-2024.04.2-764.DMG" for Mac users

*Note: The newest Rstudio works on macOS 12 or later. If you have issues installing and your Mac has an older operating system, you may need to install an older version of RStudio [here](https://dailies.rstudio.com/version/2022.07.2+576.pro12/).*
