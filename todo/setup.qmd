---
title: "EDUC 260A/PUB PLC 276A: Introduction to Programming and Data Management"
...
\- We will conduct all class-related discussions on this version control system instead of using Canvas. We will also use GitHub to collaborate on weekly problem sets, send announcements, and ask questions.

\- Follow these instructions to set up an account.

 - Go to https://github.com/ and sign up for GitHub. When creating your account, use an email address that you regularly access and expect to retain. GitHub will use this address for account verification, security notifications, and repository invitations. Also, please consider including your first and/or last name as part of your username so that we can easily identify your work, questions, and comments. 
 ...
 - Plug in your name and Github username in this [google form](https://forms.gle/sjLwN4um1mJQKTP89).

# 2. Install R

*Note: if you have already installed R and R studio, you don't need to re-install, but if compatibility issues arise later in the quarter, you may have to re-install/update.*
...
\- Select "Download R for macOS"
 ...
 - Click either "R-4.6.1-arm64.pkg" or "R-4.6.1-x86_64.pkg" depending on the version of your Mac.
...
\- Select "RStudio-2026.08.2-200.exe" for Windows users

\- Select "RStudio-2026.08.2-200.dmg" for Mac users

*Note: The newest Rstudio works on macOS 14 or later. If you have issues installing and your Mac has an older operating system, you may need to install an older version of RStudio [here](https://dailies.rstudio.com/version/2022.07.2+576.pro12/).*

<!-- # 4. Create a Quarto file that "renders" an HTML document in RStudio

\- What do we mean by this?

 - We will use Quarto for lectures and turning in problem sets (homeworks).

 - Quarto allows us to create documents in a variety of formats (HTML, pdf, word, etc.). For example, this document was created using Quarto (pdf).

 - A Quarto file is a file with a ".qmd" extension

 - [Here](https://quarto.org/docs/get-started/hello/rstudio.html) is a link to more information on Quarto.

\- Steps to follow to create a Quarto file that renders an HTML document

 - Load RStudio
 
 - At the top left corner select "File" ->"New file" -> "Quarto Document"

 - Select "HTML", title your Quarto file (optional), and click "OK"

 - Now select the blue arrow and "Render" icon

 - Give your file a name and save (you can delete later) in place that is easy to locate (Desktop, Downloads, etc.)

 - You should have a saved HTML file (extension .HTML) and a Quarto file (extension .qmd)
...
*Disclaimer: We will do our best in assisting with any issues regardless if it's a Mac or Windows.*
