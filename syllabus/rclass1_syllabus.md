...
In this course we will utilize data that reflect systemic gaps based on race, ethnicity, immigration status, and gender identity, among other aspects of identity. It is critical to acknowledge that the process of creating these data (e.g., how data collected, the categories chosen to represent identity) is based on notions of white supremacy and heteronormativity. It is also critical that we acknowledge that the social and economic marginalization reflected in data is rooted in systemic oppression that upholds white supremacy and heteronormativity. We should all be thinking about our own role in upholding these systems. 
