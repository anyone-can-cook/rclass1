...
- `df_name[df_name$var_name <condition>, ]` is an example of "subset a vector approach #3": "Using logicals to return elements where condition `TRUE`"
...
#nrow(df_school[df_school[["visits_by_110635"]] >= 1 & df_school[["visits_by_100751"]] >= 1, ]) # same
```
...
CRYSTAL/PATRICIA - ADD 2-3 MORE EXAMPLES OF FILTERING ON THIS SLIDE, USING SOME OF THE LOGICAL OPERATORS FROM PREVIOUS SLIDE
...
- How many events at public high schools with at least $50k median household income?
