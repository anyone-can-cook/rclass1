...
df_school$visits_by_100751[1:100]>1
df_school$visits_by_100751[df_school$visits_by_100751>1]
```
...
### Subset single element from object using [[]] operator, lists

Create list
```{r}
list_a <- list(1:3, "a", 4:6)
str(list_a) # print list
```
...
### The "object" `[]` versus the "contents of the object" `[[]]`

START EDITING HERE!

Wickham "Advanced R" chapter 4.3 uses the "train metaphor" to differentiate the "object" from the "contents of the object" [LINK]

- We will use this train metaphor to understand the difference between a list (the object) and the contents of the list (contents of the object)
