...
Palettes are a combination of colors displayed together. In the `RColorBrewer` package. 
...
There are three types of palette scales: sequential, diverging, and qualitative. 
