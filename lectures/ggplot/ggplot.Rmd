...
### Hue
- https://www.color-wheel-artist.com/hue/
- https://www.sensationalcolor.com/hue-value-chroma/
- Hue refers to the origin of the color we see. An easy way to think of hue is one of the six primary and secondary colors-- Yellow, Orange, Red, Violet, Blue or Green.

### Gradient
- http://www.sthda.com/english/wiki/colors-in-r#:~:text=The%20palettes%20names%20are%20%3A%20Blues,YlGn%2C%20YlGnBu%20YlOrBr%2C%20YlOrRd.
...
- most relevant for sequential palettes, progress from low to high gradient

### Palettes 
- combination of colors displayed
- palettes created in Rcolorbrewer and other libraries
